...
public class EmployeeUIServiceImpl implements IEmployeeUIService {
     ...
     *
     * @throws EmployeeServiceException This exception is thrown when user
     ...
     *
     * @throws EmployeeServiceException thrown when user want to see the employee
     ...
     * @throws EmployeeServiceException       This exception is thrown when user
     *                                        want to see the employee detail and the list is empty.
     * @throws StringIndexOutOfBoundException Thrown by String methods to
     *                                        indicate that an index is either negative or greater than the size of the
     *                                        string.
     * @throws NullPointerException           Thrown when an application
     ...
     *
     * @throws EmployeeServiceException      exception is thrown when user want to
     *                                       see the employee detail and the list is empty.
     * @throws ClassCastException            Thrown to indicate that the code has attempted
     *                                       to cast an object to a subclass of which it is not an instance.
     * @throws UnsupportedOperationException Thrown to indicate that the requested
